...
public class RegistByPhoneAddInfoActivity extends SlidingActivity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tipTv.setText(String.format(getText(R.string.regist_by_phone_tips)
				.toString(), mPhone));
		...
		mEditTextClearUtil
				.addClearBtn(findViewById(R.id.v_regist_by_phone_add_info_Button_pwClear));
		mEditTextClearUtil
				.addClearBtn(findViewById(R.id.v_regist_by_phone_add_info_Button_nickClear));
		initSmsReceiver();
		countDown();
	...
	private void registAction() {
		...
		params.addBodyParameter("password",
				MD5.encrypt(mPasswordEt.getText().toString()));
		params.addBodyParameter("nick_name", mNickEt.getText().toString());
		new HttpUtils().send(HttpMethod.POST, Constants.URL_REGISTER_BY_PHONE,
				params, httpCallBack);
	...
	RequestCallBack<Object> httpCallBack = new RequestCallBack<Object>() {
		...
		public void onSuccess(final ResponseInfo<Object> responseInfo) {
			...
			if ("0".equals(result)) {
				...
				UserPrefrence.putPassword(getApplicationContext(), mPasswordEt
						.getText().toString());
				UserPrefrence.putNickName(getApplicationContext(), mNickEt
						.getText().toString());
				UserPrefrence.putHeadPhoto(getApplicationContext(), "");
				UserPrefrence.setLogin(getApplicationContext(), true);

				MyApplication app = (MyApplication) getApplication();
				Intent intent = new Intent(RegistByPhoneAddInfoActivity.this,
						app.cls);
